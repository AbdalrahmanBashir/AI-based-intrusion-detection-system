 ...
 *
 *      AODV-UU implementation by Erik Nordstr̦m of Uppsala University
...
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    uint32_t GetRreqSent() const { return m_rreqSentCount; }
    uint32_t GetRreqReceived() const { return m_rreqReceivedCount; }
    uint32_t GetRrepSent() const { return m_rrepSentCount; }
    uint32_t GetRrepReceived() const { return m_rrepReceivedCount; }
    uint32_t GetRerrSent() const { return m_rerrSentCount; }
    uint32_t GetRerrReceived() const { return m_rerrReceivedCount; }
  ...
  private:
    ...
    bool IsMalicious;
    // Add these counters to the private section of aodv::RoutingProtocol
    uint32_t m_rreqSentCount;
    uint32_t m_rreqReceivedCount;
    uint32_t m_rrepSentCount;
    uint32_t m_rrepReceivedCount;
    uint32_t m_rerrSentCount;
    uint32_t m_rerrReceivedCount;
